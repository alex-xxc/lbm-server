...
export class BannerEntity {
    ...
    @ApiProperty({ type: String, description: 'banner图' })
    @Column({ type: 'varchar', comment: 'banner图' })
    public img: string

    @ApiProperty({ type: String, description: '移动端banner图' })
    @Column({ type: 'varchar', name: 'wap_img', comment: '移动端banner图' })
    public wapImg: string
