...
@Entity('home_content_list')
export class HomeContentListEntity {
    ...
    @ApiProperty({ type: String, description: '首页内容Id' })
    @Column({ type: 'varchar', name: 'content_id', comment: '首页内容Id' })
    public contentId: string

    @ApiProperty({ type: String, description: '首页内容标识' })
    @Column({ type: 'varchar', name: 'content_code', comment: '首页内容标识' })
