...
async function bootstrap() {
  ...
  const swaggerOptions = new DocumentBuilder()
    .setTitle('Dashan-Nest-Service App')
    .setDescription('Dashan-Nest-Service App 接口文档')
    .setVersion('1.0.0')
    .addBearerAuth()
    .build()
  ...
  SwaggerModule.setup(`${prefix}/docs`, app, document, {
    ...
    customSiteTitle: 'Dashan-Nest-Service API Docs',
  })
  ...
  Logger.log(
    Chalk.green(`--------------------------------------------------------------------`),
    '\n',
    Chalk.green(`【Dashan-Nest-Service 后端服务启动成功】`),
    '\n',
