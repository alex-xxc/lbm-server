...
export class OssController {
  ...
  async uploadFile(
    ...
    @Body() params: { business: string, type: string },
    @Req() req,
  ): Promise<ResultData> {
    return await this.ossService.create([file], params.business || '', params.type, req.user)
  }
  ...
  async uploadFileOss(
    ...
    return await this.ossService.uploadOssApi([file], params.business || '', params.type, req.user)
  }
}
